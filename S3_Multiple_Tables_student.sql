...
[??? ONDUIDELIJK OVER WELKE TABLES DEZE VRAAG GAAT ???]
...
FROM medewerkers m
INNER JOIN inschrijvingen i ON i.cursist = m.mnr WHERE (i.cursus = 'S02' AND i.begindatum = '2019-04-12')
