...
ORDER BY functie DESC, gbdatum DESC;
...
VALUES ('S02', '2024-03-02', (SELECT mnr FROM medewerkers WHERE (naam = 'SMIT' and voorl = 'N')), 'LEERDAM')
...
VALUES(8001, 'Tobias', 'T', 'STAGIAIR', 7698, '2023-12-22', 2000, 30)
ON CONFLICT DO NOTHING;                                                                                         -- [TEST]
...
ON CONFLICT DO NOTHING;                                                                                         -- [TEST]
INSERT INTO uitvoeringen (cursus, begindatum, docent, locatie) VALUES ('D&P', '2019-10-10', 7369, 'LEERDAM')
ON CONFLICT DO NOTHING;                                                                                         -- [TEST]
INSERT INTO uitvoeringen (cursus, begindatum, docent, locatie) VALUES ('D&P', '2019-10-16', 7369, 'LEERDAM')
ON CONFLICT DO NOTHING;                                                                                         -- [TEST]
INSERT INTO inschrijvingen (cursist, cursus, begindatum) VALUES (7698, 'D&P', '2019-10-10')
ON CONFLICT DO NOTHING;                                                                                         -- [TEST]
INSERT INTO inschrijvingen (cursist, cursus, begindatum) VALUES (7900, 'D&P', '2019-10-10')
ON CONFLICT DO NOTHING;                                                                                         -- [TEST]
INSERT INTO inschrijvingen (cursist, cursus, begindatum) VALUES (7521, 'D&P', '2019-10-16')
ON CONFLICT DO NOTHING;                                                                                         -- [TEST]
...
UPDATE medewerkers
SET maandsal = CASE
    WHEN (functie != 'MANAGER' AND afd = (SELECT anr FROM afdelingen WHERE naam = 'VERKOOP')) THEN maandsal * 1.055  
    WHEN (functie = 'MANAGER' AND afd = (SELECT anr FROM afdelingen WHERE naam = 'VERKOOP')) THEN maandsal * 1.07  
    ELSE maandsal
END;
...
-- Omdat deze gereferenced wordt in bestaande entries met een foreign key
...
INSERT INTO afdelingen (anr, naam, locatie) VALUES (60, 'FINANCIEN', 'LEERDAM')
ON CONFLICT DO NOTHING;                                                                                         -- [TEST]

INSERT INTO medewerkers (mnr, naam, voorl, functie, chef, gbdatum, maandsal, afd) VALUES (8001, 'POT', 'T', 'MANAGER', 7839, '1997-12-22', 2300, 60)
ON CONFLICT DO NOTHING;
                                                                                    -- [TEST]
UPDATE afdelingen SET hoofd = 8001 WHERE anr = 60;
